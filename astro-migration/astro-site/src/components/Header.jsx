...
export default function Header() {
  ...
  const navLinks = [
    <a className={headerLinksClasses} href="/writings">
      Writings
    </a>,
    <a className={headerLinksClasses} href="/bookshelf">
      Bookshelf
    </a>,
    <a className={headerLinksClasses} href="https://letter.coffee/?utm_source=aravindballa.com">
      caffeineletter ↗
    </a>,
    <a className={headerLinksClasses} href="https://hackletter.email/">
      Newsletter ↗
    </a>,
    <a
